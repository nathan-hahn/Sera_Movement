...
write.csv(meta.table, './movdata/collar metadata.csv')
...
RE-RUN AND SAVE. SLICE INFO DID NOT SAVE LAST TIME ????
...
saveRDS(t, './movdata/Sera_datasets_10Mar21_HMMclassified_20210427.rds')

sera.hmm <- readRDS('./movdata/Sera_datasets_10Mar21_HMMclassified_20210427.rds')
```
...
t <- hmm.df %>%
  arrange(cohort, MovDataID, date)
write.csv(t, './movdata/Sera_datasets_10Mar21_HMMclassified_20210524.csv')
saveRDS(t, './movdata/Sera_datasets_10Mar21_HMMclassified_20210524.rds')
